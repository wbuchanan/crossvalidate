cscript "classification prediction and data management" adofile classifyit
...
// Predict low using classifyit 
classifyit 2, ps(pred)
...
// Use classifyit to generate the predicted classes
classifyit r(r), ps(pred)
...
// Ensure the values match what classifyit produced
assert pstub == pred
